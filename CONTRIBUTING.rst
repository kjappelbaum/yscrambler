...
----------------------------------
1. Check that you have the latest version of :code:`yscrambler`
2. Check that StackOverflow hasn't already solved your problem
3. Go here: https://github.com/kjappelbaum/yscrambler/issues
...
1. Get the code. Fork the repository from GitHub using the big green button in the top-right corner of
   https://github.com/kjappelbaum/yscrambler
2. Clone your directory with

.. code-block:: sh

    $ git clone https://github.com/<YourUsername>/yscrambler
...
If you spend a while working on your changes, further commits may be made to the main :code:`yscrambler`
...
.. code-block:: sh
    ...
    $ git remote add upstream https://github.com/kjappelbaum/yscrambler
